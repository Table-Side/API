install_brotli () {
    ...
    local BROTLI_VERSION="1.1.0"
    wget -q https://github.com/google/brotli/archive/refs/tags/v${BROTLI_VERSION}.zip || exit -1 
    unzip v${BROTLI_VERSION}.zip && cd ./brotli-${BROTLI_VERSION} && mkdir build && cd build || exit -1 
